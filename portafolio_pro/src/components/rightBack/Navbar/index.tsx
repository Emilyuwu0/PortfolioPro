...
export default function Navbar() {
  ...
  return (
    <div className="pt-12">
<div className="fixed top-0  w-5xl px-4 sm:px-6 z-50 transition-colors duration-300">
  <nav className="text-white">
    <div className="flex flex-col md:flex-row md:items-center md:justify-between colorPrincipal pb-6 pt-8 md:pt-12 md:pb-10 md:px-0">
      ...
      <a
        href="#contact"
        className="bg-white text-black px-4 py-2 rounded-full font-semibold mt-4 md:mt-0"
      >
        ¡Contáctame!
      </a>
    </div>
            ...
            <div className="hero-section">
              ...
              <SlideUpSection delay={600}>
                <div className="flex justify-start w-52 mt-12" id="home">
                  ...
                  <Button colorClass="backgroundButtons mr-4">
                    Curriculum
                  </Button>
                </div>
              </SlideUpSection>
